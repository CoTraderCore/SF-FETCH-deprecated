...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor (address _router) public {
        ...
        // exclude owner from transfer limit
        _isExcludedFromTransferLimit[owner()] = true;
    ...
    function includeInTransferLimit(address account) public onlyOwner {
    ...
    function _transfer(
        ...
        if(!_isExcludedFromTransferLimit[from] && !_isExcludedFromTransferLimit[to])
